...
public class PlayerCharacter : MonoBehaviour
{
    ...
    public LayerMask ground_layer = ~0; //NOT
    ...
    [Header("Attributes")] //캐릭터 기본상태 배고픔 목마름 등등
    ...
    public UnityAction<Destructible, bool> onAttack;  //나중에 알아보도록 하자
    ...
    private Construction current_construction = null; //건축
    private ActionSleep sleep_target = null; //건축물에서만 잘수있다
